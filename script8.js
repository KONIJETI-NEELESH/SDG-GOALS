              ...
              children: [
                {
                  ...
                  children: [
                    {
                      name: "Target 8.3.1.1.1",
                      parent: "Target 8.3.1.1",
                    },
                    {
                      name: "Target 8.3.1.1.2",
                      parent: "Target 8.3.1.1",
                    },
                  ],
                },
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      name: "Target 8.4.2.1.1",
                      parent: "Target 8.4.2.1",
                    },
                    {
                      name: "Target 8.4.2.1.2",
                      parent: "Target 8.4.2.1",
                    },
                  ],
                },
                {
                  ...
                  children: [
                    {
                      name: "Target 8.4.2.2.1",
                      parent: "Target 8.4.2.2",
                    },
                    {
                      name: "Target 8.4.2.2.2",
                      parent: "Target 8.4.2.2",
                    },
                  ],
                },
  ...
  function update(source) {
    ...
    nodeEnter
      ...
      .style("fill", function (d) {
        return d.children ? "rgb(174, 0, 58)" : "rgb(174, 0, 58)";
      });
